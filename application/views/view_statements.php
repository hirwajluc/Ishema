...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Ishema | Full Statement </title>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">General Full Statement</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><strong><?php foreach ($intotal as $row) { echo $row['inputot']." Frw"; } ?></strong></td>
                                                    <td><strong><?php foreach ($outotal as $row) { echo $row['outputot']." Frw"; } ?></strong></td>
