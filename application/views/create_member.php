                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase"> Create Member Form</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body form">
                                    <form action="createamember" method="POST" role="form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="account" class="form-control input-circle-right" placeholder="0788000000" required> 
                                                </div>
                                            </div>  
                                            <div class="form-group">
                                                <label>Name</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control input-circle-right" placeholder="Name" autocomplete="off" required> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>Address</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="address" class="form-control input-circle-right" placeholder="Address" autocomplete="off"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>Email</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="email" class="form-control input-circle-right" placeholder="Email" autocomplete="off"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="username" class="form-control input-circle-right" placeholder="Username" autocomplete="off" required> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" name="password" class="form-control input-circle-right" placeholder="Password" autocomplete="off" required> 
                                                </div>
                                            </div>                                            
                                        </div>
